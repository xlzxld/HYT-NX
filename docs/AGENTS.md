# AGENTS.md —— NX 分层拉伸自动化（AI 接手文档）  v2.0
...
| 项 | 内容 |
|---|---|
| 主脚本 | `nx_extrude_runner.py`（v2.0 兼容门面 Facade + 日记入口；核心位于 `cad3d/` 包） |
